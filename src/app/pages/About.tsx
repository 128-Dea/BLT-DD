  ...
  const features = [
    {
      ...
      description:
        'Menggunakan metode AHP untuk penilaian yang terstruktur dan dapat dipertanggungjawabkan',
    ...
    },
    {
      ...
      title: 'Proses Cepat',
      description:
        'Sistem otomatis menghitung bobot dan nilai akhir dalam hitungan detik',
    ...
    <div className="min-h-screen bg-[#e6f0fa]">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <motion.div
          ...
          className="rounded-2xl shadow-xl p-12 mb-8 text-white text-center relative overflow-hidden bg-gradient-to-r from-[#386fa4] via-[#6aa4d3] to-[#386fa4]"
        >
          <div className="relative z-10">
            ...
            <p className="text-xl text-blue-100 max-w-3xl mx-auto">
              Sistem Pendukung Keputusan Penentuan Penerima Bantuan Langsung
              Tunai Dana Desa Menggunakan Metode Analytical Hierarchy Process
              (AHP)
            </p>
          ...
          >
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
              <div className="prose max-w-none text-gray-600 space-y-4">
                <p className="text-lg">
                  Sistem BLT-DD adalah aplikasi web berbasis teknologi modern
                  yang dirancang khusus untuk membantu pemerintahan desa dalam
                  menentukan kelayakan penerima Bantuan Langsung Tunai Dana
                  Desa.
                </p>
                <p>
                  Aplikasi ini menggunakan metode{' '}
                  <strong>Analytical Hierarchy Process (AHP)</strong>, sebuah
                  metode pengambilan keputusan multi-kriteria yang telah
                  terbukti efektif dalam menangani masalah kompleks dengan
                  banyak variabel.
                </p>
                <p>
                  Dengan sistem ini, proses penentuan penerima bantuan menjadi
                  lebih objektif, transparan, dan dapat dipertanggungjawabkan.
                  Data warga dianalisis berdasarkan berbagai kriteria seperti
                  pendapatan, jumlah tanggungan, pekerjaan, dan kondisi tempat
                  tinggal.
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {features.map((feature, index) => (
                ...
                >
                  <div
                    className={`w-14 h-14 bg-gradient-to-r ${feature.color} rounded-lg flex items-center justify-center mb-4 shadow-lg`}
                  >
          ...
          >
            <div className="text-center mb-8">
              <div className="flex justify-center mb-5">
                <div className="w-28 h-28 rounded-full overflow-hidden border-4 border-white shadow-xl bg-gradient-to-r from-[#386fa4] to-[#6aa4d3] p-1">
                  <div className="w-full h-full rounded-full overflow-hidden bg-slate-100 flex items-center justify-center">
                    <img
                      src={teamPhoto}
                      alt="Foto Tim Developer"
              ...
              <p className="text-lg text-gray-600">
                Kenalan dengan tim yang membangun sistem ini yukk 👋
              </p>
              <p className="text-lg text-gray-600">KELOMPOK 5 - 2024I</p>
            </div>
        ...
        >
          ...
          <p className="mt-1">Dibuat dengan hati untuk kemajuan desa Indonesia</p>
        </motion.div>
      </main>
    </div>
  );
